...
public class KhsWalidosenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namaProdi = findViewById(R.id.ProdiWaldosKHS);
        noSemester = findViewById(R.id.noSemesterKHSWaldos);
    ...
    public void showKhsMHS_WD() {
        String prodi = txtProdiKHS.getText().toString().trim();
        String semester = txtSemesterKHS.getText().toString().trim();
...
//                            JSONObject getData = jsonArray.getJSONObject(i);
                            ...
                            KhsDataWD khsDataWD = new KhsDataWD();
                            khsDataWD.setNim(nim);
                            khsDataWD.setNama(nama);
                            khsDataWD.setProdi(prodi);
                            khsDataWD.setSemester(semester);
                            khsDataWD.setImg(img);
                            list.add(khsDataWD);
